...
function animateCloudy(i) {
    ...
    $("#forecastDay" + [i]).prepend(
        "<div id='prepended' class='clouds'><div class='cloud1'></div><div class='cloud2'></div><div class='cloud3'></div></div>"
    );
...
function animateRain(i) {
    $("#forecastDay" + [i]).prepend(
        "<div id='prepended' class='clouds'><div class='cloud1'></div><div class='cloud2'></div></div><div class='rainy'></div>"
    );
...
function animateFog(i) {
    $("#forecastDay" + [i]).prepend(
        "<div id='prepended' class='sun'></div><div class='clouds'><div class='cloud1'></div><div class='cloud2'></div></div>"
    );
...
function animateWindy(i) {
    $("#forecastDay" + [i]).prepend(
        "<div id='prepended' class='clouds'><div class='cloud1'></div><div class='cloud2'></div><div class='cloud3'></div>"
    );
...
function animateSnow(i) {
    $("#forecastDay" + [i]).prepend(
        "<div id='prepended' class='clouds'><div class='cloud1'></div><div class='cloud2'></div>"
    );
