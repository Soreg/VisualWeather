...
$(document).ready(function() {
    ...
    languages.forEach(function(index) {
        $dropdown.append(
            $("<option />")
                .val(index.language.value)
                .text(index.language.name)
        );
    });
...
function searchCity(e, city, languageSelected) {
    if (e == 13) {
        ...
        $("#city").fadeTo("slow", 0, function() {
            ...
            $.ajax({
                url:
                    "https://devru-latitude-longitude-find-v1.p.mashape.com/latlon.php?location=" +
                    city, // The URL to the API. You can get this in the API page of the API you intend to consume
                ...
                error: function(err) {
                    ...
                    $("#city input").val("");
                    $("#city .errorMessage").html(
                        "Json not responding - Please try again"
                    );
                    $("#city").fadeTo("slow", 1);
                },
                beforeSend: function(xhr) {
                    xhr.setRequestHeader(
                        ...
                        "hIA7KbXmyimshEpxfXEDDkX0MipSp1SNNp7jsnH900YQMh7Jts"
        ...
        function invalidCity(city) {
            ...
            $("#city .errorMessage").html(
                "The city " +
                    ...
                    city +
                    '"' +
                    " could not be found. Please check your spelling, or choose another city."
            );
            // Fade in inputs
            $("#city").fadeTo("slow", 1);
        }
